...
def get_ip_data():
    ...
    input_model = input('What is the model number? ')
    input_dev_os = input("What is the OS associated with this device? ")
    input_deal = input('Did you get a good deal on the device? ')
    d = {"IP": input_ip, "Device OS": input_dev_os, "Device Model": input_model, "Deal": input_deal}
    return d
