...
# print my name in some colors of my choosing
print(crayons.red('J'), crayons.yellow('o'), crayons.red('r'), crayons.yellow('g'), crayons.red('e'), crayons.yellow('n'), crayons.red('s'), crayons.yellow('e'), crayons.red('n'))
